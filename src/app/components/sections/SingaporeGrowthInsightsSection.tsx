...
const insights = [
  {
    title: 'SEO in Singapore: What It Costs + What Actually Ranks in 2026',
    link: '#'
  },
  {
    title: 'Google Ads Singapore: CPC Benchmarks + How to Stay Profitable',
    link: '#'
  },
  {
    title: 'Local SEO Singapore: How to Rank in Maps for Competitive Keywords',
    link: '#'
  },
  {
    title: 'Best Digital Marketing Strategy for Singapore Brands',
    link: '#'
  },
  {
    title: 'How to Choose a Digital Marketing Agency in Singapore',
    link: '#'
  }
];

export function SingaporeGrowthInsightsSection() {
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className={`text-center mb-12 lg:mb-16 fade-in-up ${isVisible ? 'visible' : ''}`}>
          ...
          <p className="text-lg md:text-xl text-black/60 max-w-3xl mx-auto leading-relaxed">
            Practical guides covering SEO, Google Ads, local visibility, and full-funnel acquisition strategy in Singapore.
          </p>
        </div>
